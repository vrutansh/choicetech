...
import { employerLogin } from '../services/authService'
...
e.preventDefault()
try {
const res = await employerLogin(form)
login(res.token, res.role || 'employer')
...
<form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white p-8 rounded-xl shadow-md mt-10">
  <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Employer Login</h2>
  ...
  <p className="text-sm text-gray-500 mt-4 text-center">
    Don’t have an account? <a href="/employer/register" className="text-blue-600 hover:underline">Register</a>
  </p>
</form>
